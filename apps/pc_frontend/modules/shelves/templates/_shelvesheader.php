...
<head>
  ...
  <?php use_javascript('/opNotePlugin/js/shelvesinit.js') ?>
  <?php use_javascript('/opNotePlugin/js/shelves.js') ?>
  <?php use_javascript('/opNotePlugin/js/shelvesutil.js') ?>
  <?php use_javascript('/opNotePlugin/js/shelvesvalidator.js') ?>
